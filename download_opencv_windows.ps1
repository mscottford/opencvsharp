...
$version = "4100"
$uriArray = @(
    "https://github.com/mscottford/opencv_files/releases/download/${tag}/opencv${version}_win_x64.zip"
    "https://github.com/mscottford/opencv_files/releases/download/${tag}/opencv${version}_win_x86.zip"
    "https://github.com/mscottford/opencv_files/releases/download/${tag}/opencv${version}_win_arm64.zip"
)
